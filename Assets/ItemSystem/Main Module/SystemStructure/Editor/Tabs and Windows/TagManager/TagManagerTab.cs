...
namespace ItemSystem.Editor
{
    ...
    {
        public TagManagerTab(Action<bool> _InspectorValueChangeCallback, Action<IEnumerable<System.Object>, bool, bool> _TreeviewSelectionChangeCallback)
        {
        ...
        protected override void LoadHierarchy()
        {
            ...
            LoadSubTabHierarchy<SO_Tag>(true, true, true, false);
