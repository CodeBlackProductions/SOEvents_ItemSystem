...
namespace ItemSystem.SubModules
{
    ...
    /// Do NOT use this class directly, instead use <see cref="SO_Stat"/> or <see cref="SO_Stat_StaticValue"/>.
    /// </summary>
    [Serializable]
    public abstract class SO_Stat_Base : ScriptableObject, IItemModule, IItemModuleBase
    {
